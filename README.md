...
👉 [Learning Plan](https://github.com/riderBruce/programming-warmup/wiki/Learning-Plan)
It includes:
...
- ✅ CSV Logger CLI Tool (timestamped entries, mood/task/journal input, reusable utility module, standalone package structure)
